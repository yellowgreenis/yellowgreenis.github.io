...
function time() {
	setTimeout("time()", 1000);	// 1000 = 1 second
...
*/
	...
	var output = document.getElementById("time");	// Output Point / ex) id="time"
	output.innerHTML = week[day] + ", " + month + "/" + date + "/" + year + "<br/>" + hours + ":" + minutes + ":" + seconds + milliseconds + ap; // HTML Code
}
